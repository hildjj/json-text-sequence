(function() {
  var DelimitStream, JSONSequenceGenerator, JSONSequenceParser, stream,
  ...
  JSONSequenceParser = (function(_super) {
    __extends(JSONSequenceParser, _super);
  ...
  JSONSequenceGenerator = (function(_super) {
    __extends(JSONSequenceGenerator, _super);
